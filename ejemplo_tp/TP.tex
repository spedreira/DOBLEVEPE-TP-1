...
\begin{itemize}
    ...
    De esta forma:\\
    (\existe[unalinea]{k}{\ent}{0 \leq k< |ciudades| \yLuego (ciudades[k].habitantes >  50.000 \land \\res = $\small \displaystyle \sum_{j=0}^{k-1} ciudades[j].habitantes \ + ciudades[k].habitantes + \small \displaystyle \sum_{j=k+1}^{|ciudades|-1} ciudades[j].habitantes$)}\land \\ \paraTodo[unalinea]{j}{\ent}{0\leq j < |ciudades| \implicaLuego ciudades[j].habitantes \geq 0}}
